...
class Ui_LoginWindow(object):
    ...
    def setupUi(self, LoginWindow):
        ...
        LoginWindow.resize(556, 385)
        self.centralwidget = QtWidgets.QWidget(LoginWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.textEdit = QtWidgets.QTextEdit(self.centralwidget)
        self.textEdit.setGeometry(QtCore.QRect(200, 90, 231, 31))
        self.textEdit.setObjectName("textEdit")
        self.textEdit_2 = QtWidgets.QTextEdit(self.centralwidget)
        self.textEdit_2.setGeometry(QtCore.QRect(200, 140, 231, 31))
        self.textEdit_2.setObjectName("textEdit_2")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(110, 240, 93, 28))
        ...
        self.label_2.setGeometry(QtCore.QRect(130, 130, 81, 41))
    ...
    def retranslateUi(self, LoginWindow):
        ...
        self.label.setText(_translate("LoginWindow", "用户ID ："))
